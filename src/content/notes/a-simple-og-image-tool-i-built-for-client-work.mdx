...
Over the last few days, I used AI agents to help me put together a lightweight Cloudflare Worker app called **[Shareframe](https://shareframe.athenadoesnot.workers.dev/)**. Using AI agents made it easy to skip the tedious setup and just focus on making the UI fast and straightforward.
...
You can try it out at **[shareframe.athenadoesnot.workers.dev](https://shareframe.athenadoesnot.workers.dev/)**. Hopefully it saves you a bit of time on your next client project too.
